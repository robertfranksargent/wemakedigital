package com.wemakedigital.ui.text 
{
	...
	public class TextButton extends Text 
	{
		...
		{
			var color : Number = Number( "0x" + String( this.textManager.styleSheet.getStyle( "." + this.styleOver ).color ).substring( 1 ) ) ;
			if ( this.tween ) this.tween.pause() ;
			this.tween = TweenMax.to( this.textField, 0.15, { tint : color } ) ;
		}
		...
		protected function onRollOut ( e : MouseEvent ) : void
		{
			...
			{ 
				if ( this.tween ) this.tween.pause() ;
				this.tween = TweenMax.to( this.textField, 0.15, { removeTint : true } ) ;
			}
		}
